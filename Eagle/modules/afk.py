...
from Eagle.helpers.pyrohelper import get_arg
import Eagle.database.afkdb as eagledb 
from Eagle.helpers.pyrohelper import user_afk
from Eagle.modules.alive import get_readable_time
from Eagle.helpers.utils import get_message_type, Types
...
async def afk(client, message):
    ...
    if not arg:
        ...
        reason = arg
    await eagledb.set_afk(True, afk_time, reason)
...
async def afk_mentioned(_, message):
    global MENTIONED
    afk_time, reason = await eagledb.afk_stuff()
