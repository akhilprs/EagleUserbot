...
UPSTREAM_REPO_URL = "https://github.com/akhilprs/EagleUserbot"
...
async def upstream(client, message):
    ...
    if HEROKU_API is not None:
        ...
        if not HEROKU_APP_NAME:
            await status.edit(
                "`Please set up the HEROKU_APP_NAME variable to be able to update your Eagle userbot.`"
            )
            repo.__del__()
            return
        ...
        try:
            ...
            pass
        await status.edit("`Successfully Updated Your Eagle Userbot!\nRestarting, please wait...`")
    else:
        ...
        await status.edit(
            "`Successfully Updated Your Eagle Userbot!\nBot is restarting... Wait for a second!`",
        )
