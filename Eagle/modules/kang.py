...
from Eagle.helpers.pyrohelper import get_args
...
async def kang(client, message):
    ...
    if photo:
        ...
        packname = f"a{user.id}_by_eagle_{pack}"
...
async def sticker_pack_info_(client, message):
    replied = message.reply_to_message
    if not replied:
        await message.edit("`Noob...I can't fetch info from nothing, can I ?!`")
        return
