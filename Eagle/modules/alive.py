...
from Eagle import app, StartTime, CMD_HELP
...
CMD_HELP.update(
    {
        "Alive": """
🦅 **Alive** 🦅
  `alive` ~ Check if the bot is on ✅.
  `ping` ~ Shows you the speed of the bot.
"""
    }
)
...
@app.on_message(filters.regex('.alive', PREFIX) & filters.me)
async def alive(_, m):
